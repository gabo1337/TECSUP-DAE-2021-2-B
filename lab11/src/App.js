...
class App extends Component {
  ...
  componentDidMount(){
    axios.get('https://gabrielcordovaapi.herokuapp.com/series/')
    .then(res=> {
  ...
  mostrar(cod,index){
    axios.get('https://gabrielcordovaapi.herokuapp.com/series/'+cod)
    .then(res => {
      this.setState({
        pos: index,
        titulo: 'Editar',
  ...
  guardar(e){
    ...
    if(cod>0){
      ...
      axios.put('https://gabrielcordovaapi.herokuapp.com/series/'+cod,datos)
      .then(res =>{
      ...
      //nuevo registro
      axios.post('https://gabrielcordovaapi.herokuapp.com/series/',datos)
      .then(res => {
  ...
  eliminar(cod){
    ...
    if(rpta){
      axios.delete('https://gabrielcordovaapi.herokuapp.com/series/'+cod)
      .then(res =>{
            ...
            {this.state.series.map((serie,index) =>{
              return (
                <tr key={serie.id}>
                  ...
                  <td>
                    <Button variant="success" onClick={()=>this.mostrar(serie.id,index)} >Editar {index}</Button>
